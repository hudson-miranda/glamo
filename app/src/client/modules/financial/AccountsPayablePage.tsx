...
import { useQuery, listAccountsPayable, payAccount } from 'wasp/client/operations';
...
export default function AccountsPayablePage() {
  ...
  const handlePay = async (accountId: string) => {
    try {
      ...
      toast.success('Account paid successfully');
      refetch();
    } catch (error: any) {
      toast.error(error.message || 'Failed to pay account');
    }
  };
